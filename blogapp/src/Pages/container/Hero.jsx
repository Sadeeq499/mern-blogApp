    ...
    <>
      <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
        <div className="mt-10 lg:w-1/2">
          <h1 className="text-center font-roboto text-3xl font-bold text-dark-soft md:text-5xl lg:max-w-[540px] lg:text-start lg:text-4xl xl:text-5xl ">
          ...
          <div className="relative mt-10 flex flex-col gap-y-2.5 lg:mt-6 xl:mt-10">
            <div className="relative">
              <FaSearch className="absolute left-3 top-1/2 h-6 w-6 -translate-y-1/2 text-[#959EAD]" />
              <input
